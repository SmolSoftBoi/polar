...
class Migration_Create_tables extends CI_Migration {
	...
	public function up()
	{
		...
		//$this->dbforge->add_foreign_key('question_id', 'questions', 'question_id');
		//$this->dbforge->add_foreign_key('media_id', 'media', 'media_id');
		...
		//$this->dbforge->add_foreign_key('answer_id', 'answers', 'answer_id');
		...
		//$this->dbforge->add_foreign_key('question_type_id', 'question_types', 'question_type_id');
		//$this->dbforge->add_foreign_key('quiz_id', 'quizzes', 'quiz_id');
		...
		//$this->dbforge->add_foreign_key('quiz_id', 'quizzes', 'quiz_id');
		//$this->dbforge->add_foreign_key('connection_id', 'connections', 'connection_id');
		...
		//$this->dbforge->add_foreign_key('domain_id', 'domains', 'domain_id');
