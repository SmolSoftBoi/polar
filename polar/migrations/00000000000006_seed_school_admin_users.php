...
/**
 * Seed school admin users migration.
 *
 ...
 */
class Migration_Seed_school_admin_users extends CI_Migration {
	...
	public function up()
	{
		if ($this->seed)
		{
			...
			$school_admin_role = $this->db->where('role_key', 'schooladmin')->get('roles')->row();
			...
			foreach ($schools as $school)
			{
				...
				for ($i = 0; $i < $users_count; $i++)
				{
					...
					$user_roles[] = array(
						'user_id' => $user_id,
						'role_id' => $school_admin_role->role_id
					);
