...
OR define('FOPEN_WRITE_CREATE_DESTRUCTIVE', 'wb'); // truncates existing file data, use with care
defined('FOPEN_READ_WRITE_CREATE_DESCTRUCTIVE')
OR define('FOPEN_READ_WRITE_CREATE_DESTRUCTIVE', 'w+b'); // truncates existing file data, use with care
...
/**
 * Display profiler.
 * The profiler will be displayed.
 */
...
/**
 * School admin role key.
 */
defined('ROLE_KEY_SCHOOL_ADMIN') OR define('ROLE_KEY_SCHOOL_ADMIN', 'schooladmin');

/**
 * Teacher role key.
 */
defined('ROLE_KEY_TEACHER') OR define('ROLE_KEY_TEACHER', 'teacher');
