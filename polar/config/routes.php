...
$route['api/connections/search'] = 'api/connections/search';
$route['api/connections/(:num)'] = 'api/connections/get_connection/$1';
$route['api/connections']['GET'] = 'api/connections/get_connections';
$route['api/connections']['POST'] = 'api/connections/post_connections';
